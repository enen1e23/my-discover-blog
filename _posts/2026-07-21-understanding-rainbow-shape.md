...
<img src="{{ '/assets/images/rainbow/media/image1.png' | relative_url }}" style="width:4.95417in;height:3.42083in" />
...
<img src="{{ '/assets/images/rainbow/media/image2.png' | relative_url }}" style="width:5.76806in;height:4.12014in" />

图：主虹光线总偏转角 D(α) 的几何推导。光线在球形水滴中经历两次折射和一次内部反射。作者绘制。

<img src="{{ '/assets/images/rainbow/media/image3.jpeg' | relative_url }}" style="width:3.23056in;height:3.23056in" />
...
<img src="{{ '/assets/images/rainbow/media/image4.png' | relative_url }}" style="width:5.76806in;height:2.78333in" />

图：偏转角极小值与彩虹光线的集中。相同大小的入射角区间I1 和I2，αₘ 附近的I1 只对应很小的偏转角范围 J₁，因此红色光线出射后更加集中，也更明亮。作者绘制。

<img src="{{ '/assets/images/rainbow/media/image5.png' | relative_url }}" style="width:5.76806in;height:3.02361in" />

# 3.无数水滴为什么组成圆弧

D(α) 存在最小值，最小值附近的光线集中，那么太阳光偏转的方向为这种状态下的D(α)，更容易被我们看到。

<img src="{{ '/assets/images/rainbow/media/image6.jpeg' | relative_url }}" style="width:4.16667in;height:3.05139in" alt="Graph" />

图：主虹的观察角约为42.5°。来源：Plus Magazine，“Maths behind the rainbow”

<img src="{{ '/assets/images/rainbow/media/image7.png' | relative_url }}" style="width:5.76806in;height:2.16319in" />
...
<img src="{{ '/assets/images/rainbow/media/image8.jpeg' | relative_url }}" style="width:4.16667in;height:3.70486in" alt="Graph" />

图：笛卡尔关于主虹与副虹形成的示意图，出自《气象学》第八篇“论彩虹”（1637）

<img src="{{ '/assets/images/rainbow/media/image9.jpeg' | relative_url }}" style="width:5.75972in;height:4.32014in" alt="IMG_20210526_181035" />

图：主虹。作者摄于北京，2021年5月

<img src="{{ '/assets/images/rainbow/media/image10.jpeg' | relative_url }}" style="width:5.75972in;height:4.32014in" alt="IMG_20210526_181131" />
